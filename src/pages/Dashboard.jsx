  ...
  return (
    <div className='page'>
      ...
      <table>
        ...
        <ul>
          <li><button className='cur' onClick={()=>{setShowTime(!showTime)}}>Check Load Sheding schedule</button></li>
          <li ><button className='cur' onClick={()=>{user!==null ? setPayBills(!payBills): null}}>Pay Bills</button></li>
        </ul>
        // ({user===null ? <p>Sign In First to pay bills</p> : null})
        }
    ...
    <h2>Account Information</h2>
      ...
      {/* Input of type file */}
      <h3>
      <label htmlFor="fileInput">Upload Document:</label></h3>
